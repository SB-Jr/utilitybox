#!/usr/bin/env python3
'''
This is a Visualization code snippet
This snippet will club together 2 images and plot them in matplotlib
1st Image can be the input image 
2nd Image can be the processed image for comparison
'''
import numpy as np
